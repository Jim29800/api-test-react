window.CreateProductComponent = React.createClass({
    ...
    componentDidMount: function () {
        this.serverRequest = $.get("http://localhost/private/api/category/read.php", function (categories) {
            this.setState({
    ...
    onSave: function (e) {
        ...
        $.ajax({
            url: "http://localhost/private/api/product/create.php",
            type: "POST",
        ...
        return (
            <div>
...

                {
                    ...
                    this.state.successCreation == "Unable to create product." ?
                        <div className='alert alert-danger'>
                            Impossible de sauvegarder le produit. Veuillez ...
                </div>
                        : null
                }
                ...
                <a href='#'
                    ...
                    className='btn btn-primary margin-bottom-1em'> Liste des produits
        </a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select
                                        ...
                                        <option value="-1">Selectionner une catégorie</option>
                                        {categoriesOptions}
                                    </select>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button
                                        ...
                                        onClick={this.onSave}>Enregistrer</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
