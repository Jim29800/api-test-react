...
window.UpdateProductComponent = React.createClass({
    ...
    componentDidMount: function () {
        ...
        // read categories
        this.serverRequestCat = $.get("http://localhost/private/api/category/read.php",
            function (categories) {
                this.setState({
        ...
        this.serverRequestProd = $.get("http://localhost/private/api/product/read_one.php?id=" + productId,
            function (product) {
        ...
        $('.page-header h1').text('Produit mis à jour');
    },
    ...
    onSave: function (e) {
        ...
        $.ajax({
            url: "http://localhost/private/api/product/update.php",
            type: "POST",
                            ...
                            <tr>
                                ...
                                <td>
                                    <button
                                        ...
                                        onClick={this.onSave}>Enregister</button>
                                </td>
                            </tr>
